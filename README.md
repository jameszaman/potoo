...
│   │   ├── repo/             # repository layer wrapping generated queries
...
New packages (`internal/providers/`, `internal/notifications/`, etc.) are added as each phase is implemented — not before.

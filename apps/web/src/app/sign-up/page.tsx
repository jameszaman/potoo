  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white border border-gray-200 rounded-lg p-8 w-full max-w-sm shadow-sm">
        ...
        <p className="text-sm text-gray-500 mb-6">Get started with NotifyLayer.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">Password <span className="text-gray-400">(min 8 chars)</span></label>
            <input
              type="password"
              required
              minLength={8}
